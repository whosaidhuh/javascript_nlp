// https://github.com/avikj/textrank-demo
'use strict';
var natural = require('natural');
var fs = require('fs');


var textString = 'A statistical way of comparing two (or more) techniques, typically an incumbent against a ' +
    'new rival. A/B testing aims to determine not only which technique performs better but also to understand ' +
    ...
    'accuracy is defined as follows: In binary classification, accuracy has the following definition:' +
